...
This issue tracker is only for technical issues related to SMRTC Core.
General SMRTC questions and/or support requests and are best directed to the [SMRTC Discord](https://discord.smrtc.org).
...
### What version of SMRTC Core are you using?
