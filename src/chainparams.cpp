...
public:
    CMainParams()
    {
        ...
        nZerocoinStartTime = 1531153353 ; // 07/09/2018 @ 4:22pm (UTC)
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1531153353;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 637292;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000001651a2d910a40e4358e67fed3d5028379b00c7f90b03b44fe613f3bb217"));
        assert(genesis.hashMerkleRoot == uint256("44c710c053ebac8a6c6ad9c45232d60530b570bd38a638e842a5efa5692e7232"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smrtc-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smrtc-testnet.seed2.fuzzbawls.pw"));
