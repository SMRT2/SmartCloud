...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Smrtc Core smrtc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  smrtc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smrtc transaction") + "\n" +
                               "  smrtc-tx [options] -create [commands]   " + _("Create hex-encoded smrtc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded smrtc transaction
