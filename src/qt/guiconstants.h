...
/* Smrtc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SMRTC"
#define QAPP_ORG_DOMAIN "smrtc.org"
#define QAPP_APP_NAME_DEFAULT "SMRTC-Qt"
#define QAPP_APP_NAME_TESTNET "SMRTC-Qt-testnet"
