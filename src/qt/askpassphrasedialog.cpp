                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zSmrtc || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending Smrtc because you wouldn't check it anyway.
    if (context == Context::Send_Smrtc || context == Context::Send_zSmrtc) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("SMRTC will close now to finish the encryption process. "
