...
/** Utility functions used by the SMRTC Qt UI.
 */
namespace GUIUtil
{
...
// Render SMRTC addresses in monospace font
...
// Parse "smrtc:" URI into recipient object, return true on successful parsing
