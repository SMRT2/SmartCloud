...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"smrtc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"smrtc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"smrtc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:52311/\n";
}
